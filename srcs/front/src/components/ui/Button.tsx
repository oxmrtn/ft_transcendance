...
export default function Button({
  ...
  const baseStyles = `flex items-center justify-center gap-2 py-2 px-4 text-white font-bold border border-px transition-all duration-200 cursor-pointer uppercase font-mono
