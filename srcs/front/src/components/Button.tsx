...
export default function Button({
  ...
  const baseStyles = "py-2 px-4 rounded-md text-white font-bold border border-px border-white/10 transition-all duration-200 hover:cursor-pointer disabled:hover:cursor-default disabled:opacity-50";
